...
public class TabsPagerTitleStrip extends HorizontalScrollView {
    ...
    public TabsPagerTitleStrip(Context context) {
        ...
        tabTextIconUnselectedColor = TabsHelper.getIntAlphaColor(Theme.getColor(Theme.key_actionBarDefaultIcon), 0.35f);
    ...
    public void addTabWithCounter(final int position, View view) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, TabsConfig.chatsTabCounterSize);
        ...
        textView.setPadding(AndroidUtilities.dp(TabsConfig.chatsTabCounterSize - 7), 0,
                AndroidUtilities.dp(TabsConfig.chatsTabCounterSize - 7), 0);
    ...
    public void updateCounter(int position, int count, boolean allMuted) {
        ...
        if (frame != null && frame.getChildCount() > 1) {
            ...
            if (tv != null) {
                if (count > 0 && !TabsConfig.hideTabsCounters) {
                    tv.setVisibility(VISIBLE);
                    tv.setText(count >= 10000 ? "+9999" : String.format(Locale.getDefault(), "%d", count));
                ...
                tv.setPadding(AndroidUtilities.dp(TabsConfig.chatsTabCounterSize - 7), 0,
                        AndroidUtilities.dp(TabsConfig.chatsTabCounterSize - 7), 0);
            }
        }
    }
